...
public class TestContactList {
    public static void main(String[] args) {
        ...
        int compare = Contact.compareTo(jSmith, francis);
        if (compare == 0) {
            System.out.println(Contact.toString(jSmith) + "\n" + Contact.toString(francis));
        }
        else if (compare < 0) {
            System.out.println(Contact.toString(jSmith) + "\n" + Contact.toString(francis));
        }
        else if (compare > 0) {
            System.out.println(Contact.toString(francis) + "\n" + Contact.toString(jSmith));
        }

        contactList.remove("Paul");
